      ...
      <li className="p-0">
        <Link
          ...
          className={`flex items-center gap-3 p-3 rounded-xl transition-all duration-200 w-full justify-start group hover:shadow-md ${
            isActive
              ? 'bg-gradient-to-r from-primary/15 to-secondary/15 border border-primary/30 shadow-md ring-2 ring-primary/20'
  ...
  return (
    <div className="fixed bottom-8 right-8 z-[999] lg:bottom-6 lg:right-6">
      <div className="fab fab-end">
        ...
        <ul 
          className={`menu menu-sm bg-base-100/98 backdrop-blur-xl shadow-2xl border border-base-200/40 rounded-2xl p-1 min-w-[300px] z-[1000] transition-all duration-200 ease-out origin-bottom-right pointer-events-auto ${
            isOpen
              ...
              <li className="p-3 border-b border-base-200/30 mb-2">
                <div className="flex items-center gap-3">
                  {avatarImage ? (
                    ...
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-secondary flex items-center justify-center text-primary-content font-bold text-sm ring-2 ring-primary/20">
                      {avatarLetter}
                    </div>
                  )}
