  ...
  return (
    <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-12 space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-4xl font-bold bg-gradient-to-r from-base-content to-primary bg-clip-text text-transparent">
            Inference History
          </h1>
      ...
      {docs.length > 0 ? (
        ...
        <div className="text-center py-20 px-8 space-y-6 bg-base-200/50 rounded-2xl border-2 border-dashed border-base-300">
          <div className="w-24 h-24 mx-auto bg-gradient-to-r from-primary/20 to-secondary/20 rounded-full flex items-center justify-center">
